      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-2 grid-rows-6 gap-y-8 sm:gap-x-8 sm:px-40">
        {post.slice(0, 6).map((item) => (
          <motion.div initial={
            ...
            once:true
          }} key={item._id} className="flex flex-col group overflow-hidden rounded-2xl shadow-xl">
            <div className="relative">
              <img 
                className="rounded-t-2xl w-full h-[197px] object-cover group-hover:scale-110 duration-300 "
                src={item.image}
                alt=""
              />
              <p
...
export default Featured_Vehicles_Slice;
